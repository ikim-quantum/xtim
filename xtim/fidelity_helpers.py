...
def _augmented_circuit(circuit: "xtim.Circuit", products: list[str]) -> "xtim.Circuit":
...
def _full_support_fidelity(circuit: "xtim.Circuit",
                           gens: "list[tuple[dict, dict]]",
                           k: int,
                           *,
                           p: "float | None",
...
def fidelity_from_logicals(circuit: "xtim.Circuit",
                           logicals: dict,
                           *,
                           p: "float | None" = None,
                           shots: int = 10 ** 6,
