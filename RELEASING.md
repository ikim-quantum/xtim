...
Current state: **3.0.0 is the released public version** (cut from `main`,
2026-08-29). The 2.7.0 cut was made on a side branch (`release/v2.7-public`)
...
7. Build the orphan commit and push (recipe below).
...
git push public public-main:main                 # public main = the orphan commit
