...
Current state: **3.1.1 is the released public version** (cut from `main`,
2026-09-07; public `main` = the 3.1.1 orphan, tag `v3.1.1`; previous: 3.1.0 =
the 3.1.0 orphan, tag `v3.1.0`, and 3.0.1 = orphan `a5e1949`). The 2.7.0 cut was
